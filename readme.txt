...
2. 在客户端的终端或命令提示符中执行以下命令：
    python reversetcpclient.py <ServerIP> <ServerPort> <Filename> [<Lmin> <Lmax>]
例如：
    python reversetcpclient.py 127.0.0.1 12345 example.txt 50 100
    python reversetcpclient.py 127.0.0.1 12345 example.txt
(2)客户端代码说明：
